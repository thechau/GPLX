...
class TrickViewController: UIViewController {
    ...
    var model = TrickViewModel()
    override func viewDidLoad() {
        super.viewDidLoad()
        setData()
        tbView.register(UINib(nibName: "TrickCell", bundle: nil), forCellReuseIdentifier: TrickTableViewCell.reuseIdentifier)
        // Do any additional setup after loading the view.
    }
    
    func setData(){
        var data = readDataFromCSV(fileName: "tips", fileType: "csv")
...
extension TrickViewController: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: TrickTableViewCell.reuseIdentifier, for: indexPath) as! TrickTableViewCell
        cell.data = data
